...
public final class BlConstants {
  ...
  public static final String PRODUCT_STRING = "BUSYLIGHT";
  public static final int PRODUCT_ID = 15309;
  public static final int VENDOR_ID = 10171;
  public static final  int MAX_BUFFER_LENGTH=62;
  public static final  int MAX_VOLUME=7;
  public static final  int MIN_VOLUME=0;

  public enum BufferPositions{
    RED(2),
    GREEN(3),
    BLUE(4),
    TONE(7),
